import { DiscordjsError, Locale, ShardingManagerOptions } from 'discord.js';
import { config } from 'dotenv';
import { join } from 'path';
import { ShardingManager } from './Client';
...
new ShardingManager(tsNodeRun ? './src/bot.ts' : './dist/bot.js', options)
    .spawn()
    .catch((err:unknown) => {
